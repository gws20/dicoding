...
public class Api {
    public final static java.lang.String API_HOST = "https://api.themoviedb.org/3/discover/%s?api_key=07d29b89e107ae225810a189159b21a3&language=en-US"; //{jenis}
    public final static java.lang.String API_DETAIL_HOST = "https://api.themoviedb.org/3/{jenis}/{id}?api_key=07d29b89e107ae225810a189159b21a3&language=en-US&append_to_response=credits"; //{jenis,id}
    public final static java.lang.String IMG_HOST = "https://image.tmdb.org/t/p/%s/%s"; //path param={size,name}


    public final static java.lang.String MOVIE = "movie";
    public final static java.lang.String TV = "tv";
    public final static java.lang.String ID = "id";
    public final static java.lang.String JENIS = "jenis";
    public final static java.lang.String NAME = "name";

    public final static class SIZE {
        public final static java.lang.String W_ORIGINAL = "original";
        public final static java.lang.String W_92 = "w92";
        public final static java.lang.String W_154 = "w154";
        public final static java.lang.String W_185 = "w185";
        public final static java.lang.String W_342 = "w342";
        public final static java.lang.String W_500 = "w500";
        public final static java.lang.String W_780 = "w780";
    }

    public final static java.lang.String HOST_MOVIE = java.lang.String.format(API_HOST,MOVIE);
    public final static java.lang.String HOST_TV = java.lang.String.format(API_HOST,TV);

    //API Constants
    public final static java.lang.String RESULTS = "results";
    ...
    private static List<java.lang.String> getGenresString(JSONArray genresArr) throws JSONException {
        List<java.lang.String> genres = new ArrayList<>();
        for(int i=0;i<genresArr.length();i++){
            JSONObject item = genresArr.getJSONObject(i);
            genres.add(item.getString(FilmEntity.NAME));
        }
    ...
    private static java.lang.String getProdCompany(JSONArray compArr) throws JSONException {
        StringBuilder production_companies = new StringBuilder();
        for(int i=0;i<compArr.length();i++){
            java.lang.String item = compArr.getJSONObject(i).getString(FilmEntity.NAME);
    ...
    private static java.lang.String getStringFromJSON(JSONObject jsonObject, java.lang.String key) throws JSONException {
        return jsonObject.has(key)?(!jsonObject.getString(key).equals("null")?jsonObject.getString(key):null):null;
    }

    private static int getIntFromJSON(JSONObject jsonObject, java.lang.String key) throws JSONException {
        return jsonObject.has(key)?jsonObject.getInt(key):0;
    }

    private static long getLongFromJSON(JSONObject jsonObject, java.lang.String key) throws JSONException {
        return jsonObject.has(key)?jsonObject.getLong(key):0;
    }
    private static Boolean getBooleanFromJSON(JSONObject jsonObject, java.lang.String key) throws JSONException {
